...
public class PlatoonRepository : IPlatoonRepository
{
	...
	public async Task<List<PlatoonModel>> GetPlatoonsByCompany(int CompanyId)
	{
		return (await _dataAccessHelper.QueryData<PlatoonModel, dynamic>("usp_GetPlatoonsByCompanyId", new { CompanyId }));
	}
