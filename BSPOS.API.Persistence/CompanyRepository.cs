...
public class CompanyRepository : ICompanyRepository
{
	...
	public async Task<List<CompanyModel>> GetCompanysByUnit(int UnitId)
	{
		return (await _dataAccessHelper.QueryData<CompanyModel, dynamic>("usp_GetCompanysByUnitId", new { UnitId }));
