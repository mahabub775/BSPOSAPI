...
public class Startup
{
	...
	public void ConfigureServices(IServiceCollection services)
	{
		...
		services.AddScoped<ICandidateGPTRepository, CandidateGPTRepository>();
		services.AddScoped<ICandidateAddlQualificationRepository, CandidateAddlQualificationRepository>();
		services.AddScoped<ICandidateCadreRepository, CandidateCadreRepository>();
		services.AddScoped<ICandidateCertificationRepository, CandidateCertificationRepository>();
		services.AddScoped<ICandidateCivilEducationRepository, CandidateCivilEducationRepository>();
		services.AddScoped<ICandidateMilitaryTrainingRepository, CandidateMilitaryTrainingRepository>();

		services.AddScoped<ICandidateIPFTRepository, CandidateIPFTRepository>();
		services.AddScoped<ICandidateRETRepository, CandidateRETRepository>();
		services.AddScoped<ICandidateAssultCourseRepository, CandidateAssultCourseRepository>();
		services.AddScoped<ICandidateCompetitionRepository, CandidateCompetitionRepository>();
		services.AddScoped<ICandidateQuizCompetitionRepository, CandidateQuizCompetitionRepository>();
		services.AddScoped<ICandidateDisciplineRepository, CandidateDisciplineRepository>();
	}
